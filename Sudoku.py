...
class PyGameBoard():
  ...
  def __drawUI(self):
    ...
    self.__titleText = font.render('Bianca & Lavinia', 1, (0, 0, 0))
    self.__titleTextRect = self.__titleText.get_rect()
    self.__titleTextRect.centerx = 445
    ...
    self.__newGameText = font.render('-Les nouveau jeux-', 1, (0, 0, 0))
    ...
    self.__solveText = font.render('-Resoudre-', 1, (0, 0, 0))
    ...
    font = pygame.font.Font('gunny.ttf', 30)
    self.__checkText = font.render('-Verifier la solution-', 1, (0, 0, 0))
